...
//    }
//
//    @WithMockUser(username = "test7777", roles = {"MEMBER"})
//    @DisplayName("회원_전체_정보_조회")
//    @Test
//    void memberDetailInfo() throws Exception {
//        String loginId = "test7777";
//
...
//        member.setLoginPw("test7777");
//        member.setName("사용자7");
//        member.setStuNum("7777");
//        member.setMajor("컴퓨터소프트웨어공학과");
//        member.setPhoneNum("777-7777-7777");
//        member.setEmail("사용자7@kumoh.ac.kr");
//        member.setGender("여");
//        member.setBirthDate("2001-07-07");
